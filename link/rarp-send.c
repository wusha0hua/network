...
void RarpReqPacketCreate(unsigned char *buf,DeviceInfo *dvif,char *dstmac)
{
	char dstip[4]={0,0,0,0};
...
int main()
{
	...
	char dstmac[6]={0x54,0x75,0x95,0xb9,0x45,0x17};
	EtherHeaderCreate(packet,&dvif);
	RarpReqPacketCreate(packet+sizeof(struct ether_header),&dvif,dstmac);
