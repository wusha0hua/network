...
unsigned short csum(char *buf,int n)
{
	unsigned long sum;
	for(sum=0;n>0;n--)
	{
...
int main(int argc, char *argv[])
{
	...
	/*unsigned char DNS[] = { 0xd8, 0xcb , 0x01, 0x00, 0x00, 0x01, 0x00 ,0x00,
		...
		0x01 };*/
	unsigned char DNS[]={0x05,0xe5,0x01,0x00,0x00,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0x05,0x62,0x61,0x69,0x64,0x75,0x03,0x63,0x6f,0x6d,0x00,0x00,0x01,0x00,0x01};
	...
	char forUDPCheckSum[sizeof(struct UDP_PSD_Header)+sizeof(struct udphdr)+sizeof(DNS)+1];
	...
	udp->check=csum((char*)forUDPCheckSum,(sizeof(struct udphdr)+sizeof(struct UDP_PSD_Header)+sizeof(DNS)));
